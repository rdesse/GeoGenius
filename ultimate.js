...
function updateScore(score) {
    var meilleurScore = localStorage.getItem('highscoreUlt');

    if (score > meilleurScore) {
        localStorage.setItem('highscoreUlt', score);
    }
}
...
function meilleurScore() {
    ...
    if (meilleurScore !== null) {
        ret=localStorage.getItem('highscoreUlt');
    } else {
        ret=0;
    }
...
$("#population-btn").click(function () {
    if(paysA.population==paysB.population){
        reussi=true;
        score++;
    }else if(paysA.population > paysB.population){
        reussi=false;
    }else{
        reussi=true;
        score++;
...
$("#superficie-btn").click(function () {
    if(paysA.superficie==paysB.superficie){
        reussi=true;
        score++;
    }else if(paysA.superficie > paysB.superficie){
        reussi=false;
    }else{
        reussi=true;
        score++;
...
$("#aucun-btn").click(function () {
    if((paysA.population>=paysB.population)&&(paysA.superficie>=paysB.superficie)){
        reussi=true;
        score++;
    }else{
        reussi=false;
