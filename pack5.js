...
function updateScore(score) {
    var meilleurScore = localStorage.getItem('highscorePac');

    if (score > meilleurScore) {
        localStorage.setItem('highscorePac', score);
    }
}
...
function meilleurScore() {
    ...
    if (meilleurScore !== null) {
        ret=localStorage.getItem('highscorePac');
    } else {
        ret=0;
    }
...
function montrerDeck() {
    ...
    drap1.style.display = 'inline';
    drap2.style.display = 'inline';
    drap3.style.display = 'inline';
    drap4.style.display = 'inline';
    drap5.style.display = 'inline';
    ...
    pays4=deckPays[3];
    pays5=deckPays[4];
    $("#pays1").html(pays1.nom);
    $("#pays2").html(pays2.nom);
    $("#pays3").html(pays3.nom);
    $("#pays4").html(pays4.nom);
    $("#pays5").html(pays5.nom);

    //Ajouter les drapeaux
    drap1.setAttribute('src', 'images/'+pays1.nom+'.png');
    drap2.setAttribute('src', 'images/'+pays2.nom+'.png');
    drap3.setAttribute('src', 'images/'+pays3.nom+'.png');
    drap4.setAttribute('src', 'images/'+pays4.nom+'.png');
    drap5.setAttribute('src', 'images/'+pays5.nom+'.png');

    document.getElementById('drapeau1').appendChild(drap1);
    document.getElementById('drapeau2').appendChild(drap2);
    document.getElementById('drapeau3').appendChild(drap3);
    document.getElementById('drapeau4').appendChild(drap4);
    document.getElementById('drapeau5').appendChild(drap5);
}
...
function cacherDeck() {
    ...
    drap1.style.display = 'none';
    drap2.style.display = 'none';
    drap3.style.display = 'none';
    drap4.style.display = 'none';
    drap5.style.display = 'none';
}

//Créer la liste déroulante
function creerListe() {
    for (var i = 0; i < deckPays.length; i++) {
        var option = document.createElement("option");
        option.value = deckPays[i].nom;
        option.text = deckPays[i].nom;
...
var pays4;
var pays5;
var drap1 = document.createElement('img');
var drap2 = document.createElement('img');
var drap3 = document.createElement('img');
var drap4 = document.createElement('img');
var drap5 = document.createElement('img');
var paysAd;
var drapAd = document.createElement('img');
...
//Avance d'un tour pendant la création du deck
function avanceTourDeck() {
    if(tourDeck!=4){
...
$("#paysA-btn").click(function () {
    deckPays.push(paysA);
    avanceTourDeck();
});

$("#paysB-btn").click(function () {
    deckPays.push(paysB);
    avanceTourDeck();
});

$("#continuer-btn").click(function () {
    cacherDeck();
    $("#continuer-btn").hide();
    $("#highscore").show();
    ...
    paysAd=tableauPays.shift();
    $("#paysAd").html(paysAd.nom);
    drapAd.setAttribute('src', 'images/'+paysAd.nom+'.png');
    document.getElementById('drapeauAd').appendChild(drapAd);
    creerListe();
});